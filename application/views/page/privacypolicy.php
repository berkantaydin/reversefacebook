<div class="row">
    <div class="span12">
        <h1>Privacy Policy for face-finder.com</h1>

        If you require any more information or have any questions about our
        privacy policy, please feel free to contact us by email at
        pp@berkantaydin.com.tr.

        <br><br>

        At face-finder.com, the privacy of our visitors is of extreme importance to
        us. This privacy policy document outlines the types of personal
        information is received and collected by face-finder.com and how it is used.

        <br><br>

        <h2>Log Files</h2>

        Like many other Web sites, face-finder.com makes use of log files. The
        ...
        face-finder.com does use cookies to store information about visitors
        ...
        based on their visit to face-finder.com and other sites on the Internet. <br>
        ...
        advertisements and links that appear on face-finder.com send directly to your
        ...
        face-finder.com has no access to or control over these cookies that are used
        ...
        for instructions about how to opt-out of certain practices. face-finder.com's
